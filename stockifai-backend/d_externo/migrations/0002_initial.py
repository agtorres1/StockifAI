# Generated by Django 5.0.6 on 2025-09-08 20:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taller', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='registros_frecuencia_alta', to='user.taller')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('std_pasada_52_semanas', models.FloatField(verbose_name='Desviación Estándar Últimas 52 Semanas')),
                ('coef_var_52', models.FloatField(verbose_name='Coeficiente de Variación 52 Semanas')),
                ('taller', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='registros_intermitente', to='user.taller')),
            ],
        ),
    ]
